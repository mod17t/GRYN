      ...
      <div className="w-full max-w-md">
        ...
        <div className="space-y-5">
          ...
          <button
            ...
            className="w-full py-3 bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 text-white font-medium rounded-lg shadow-lg hover:shadow-xl transition-all"
          >
            Se connecter
          </button>
        </div>
